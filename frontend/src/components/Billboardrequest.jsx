            ...
            <div className='justify-between h-[7%] gap-10  flex sm:flex-row flex-col'>
                <div className='grid  grid-cols-1 sm:grid-cols-2 gap-20  w-[60%] '>
                    ...
                    <div className=' text-xl flex flex-col items-center justify-center border-b border-white   text-white'>
                        ...
                        <div className='flex flex-col items-center justify-center mt-2'> You can find right billboards by different search criteria / filters like billboard type, size, cities, price range and more.</div>
                    ...
                    <div className=' text-xl flex flex-col items-center border-b border-white justify-center  text-white'>
                        ...
                        <div className='flex flex-col items-center justify-center mt-2'>You can compare your favorite billboards for decision making. Simply add to compare upto three billboards & see the detailed comparison.</div>
                    </div>
                    <div className=' text-xl flex flex-col items-center border-b border-white justify-center  text-white'>
                        <span className=' text-3xl font-semibold'>03.
                            Email Alerts</span>
                        <div className='flex flex-col items-center justify-center mt-2'>You can choose a criteria & set email alert. This feature send you email whenever a new billboard matching with your criteria is available.</div>
                    </div>
                </div>
                <div className=''>
                    <SignInFour />
